                            ...
                            <div className="mb-3" key={field.name}>
                              ...
                              <div className="input-group">
                                ...
                                <Field
                                  ...
                                  step="0.01"
                                  className={`form-control ${
                                    touched.inventoryMetaData?.[field.name] &&
                                    errors.inventoryMetaData?.[field.name]
                                      ? 'is-invalid'
                                      : ''
                                  }`}
                                />
                          ...
                          values.inventoryMetaData?.quantity ? (
                            <div className="border rounded p-3 bg-light mb-4">
                              ...
                              <p className="mb-0 text-muted small">
                                ...
                                {values.inventoryMetaData.valuationMethod ||
                                  'FIFO'}
                              </p>
                            </div>
                          ) : (
                              ...
                              <div className="mt-4">
                                {values.inventoryMetaData?.quantity === 0 && (
                                  <div className="alert alert-danger mb-2">
                                    <strong>Warning:</strong> You are creating
                                    an inventory with zero quantity.
                                  </div>
                                )}
                                ...
                                {values.inventoryMetaData?.availableQuantity <
                                  ...
                                  <div className="alert alert-warning mb-2">
                                    <strong>Notice:</strong> Available quantity
                                ...
                                {values.inventoryMetaData?.backOrderable ===
                                  ...
                                  values.inventoryMetaData?.inStock ===
                                    ...
                                    <div className="alert alert-info mb-2">
                                      <strong>Note:</strong> This product will
                                      be available for back orders when out of
                                      stock.
                                    </div>
                                  )}
                              </div>
