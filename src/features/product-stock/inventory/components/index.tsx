        ...
        <div className="card-body">
          <ul className="list-unstyled mb-0">
            ...
            <li className="row flex-wrap mb-3">
              ...
              <div className="col-6">
                <span className="text-muted">{inventory.reservedQuantity}</span>
              </div>
            </li>
            <li className="row flex-wrap mb-3">
              <div className="col-6">
              ...
              <div className="col-6">
                <span className="text-muted">{inventory.reorderThreshold}</span>
              </div>
            </li>
            <li className="row flex-wrap mb-3">
              <div className="col-6">
              ...
              <div className="col-6">
                <span className="text-muted">{inventory.reorderQuantity}</span>
              </div>
            </li>
